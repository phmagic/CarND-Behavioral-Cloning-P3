...
data_dirs = ['data', 'data_reverse', 'data_edge', 'data_reg']
...
csv_logger = CSVLogger('simple_training.log')
early_stop = EarlyStopping(min_delta=0.002)
model_checkpoint = ModelCheckpoint('simple.{epoch:02d}-{val_loss:.2f}.hdf5')
